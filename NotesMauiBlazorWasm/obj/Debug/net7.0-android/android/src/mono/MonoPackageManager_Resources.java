...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "NotesMauiBlazorWasm.dll" comes first in this list. */
		"NotesMauiBlazorWasm.dll",
		"Microsoft.Maui.dll",
		...
		"NotesMauiBlazorWasm.Common.Components.dll",
		"NotesMauiBlazorWasm.Common.dll",
	};
